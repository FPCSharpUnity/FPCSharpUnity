...
#pragma warning restore 649
  ...
  public interface IElementView : IDisposable {
    ...
    bool tryToReassignData(IElementData<IElementView> newData);
  }
    ...
    IElementData<IElementView>, IViewFactory<IElementView>, IElementView 
  {
    ...
    public bool tryToReassignData(IElementData<IElementView> newData) => false;
  ...
  public class PooledElementView<Obj> : IElementView where Obj : Component {
    ...
    public bool tryToReassignData(IElementData<IElementView> newData) {
      disposable.Dispose();
    ...
    where Obj : Component 
  {
    ...
    public override IDisposable setup(Obj view) {
