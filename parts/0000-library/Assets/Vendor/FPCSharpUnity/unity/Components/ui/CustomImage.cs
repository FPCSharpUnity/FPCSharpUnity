...
namespace FPCSharpUnity.unity.Components.ui
{
    ...
    // This is a copy on Unity Image class with some additions.
    // Most of the additions are in a separate file `CustomImage.Additions.cs`
    ...
    /// </summary>
    public partial class CustomImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        public enum Type
        {
            ...
            // FPCSharpUnity values
            // These are offset on purpose, because unity may add new values to this struct
        ...
        [SerializeField, ShowIf(nameof(showPreserveAspect))] private bool m_PreserveAspect = false;
        ...
        [SerializeField, ShowIf(nameof(showFillCenter))] private bool m_FillCenter = true;
        ...
        [SerializeField, ShowIf(nameof(showFillMethod))] private FillMethod m_FillMethod = FillMethod.Radial360;
        ...
        [Range(0, 1)]
        [SerializeField, ShowIf(nameof(showFillValues))]
        ...
        [SerializeField, ShowIf(nameof(showFillValues))] private bool m_FillClockwise = true;
        ...
        [SerializeField, ShowIf(nameof(showFillValues))] private int m_FillOrigin;
        ...
        [SerializeField, ShowIf(nameof(isSimple))] private bool m_UseSpriteMesh;
        ...
        protected override void OnPopulateMesh(VertexHelper toFill)
        {
            ...
            switch (type)
            {
                ...
                case Type.TransparentEdgesBoth:
                    GenerateTransparentEdgesSprite(toFill, transparentLeft: true, transparentRight: true);
                    break;
                case Type.TransparentEdgesLeft:
                    GenerateTransparentEdgesSprite(toFill, transparentLeft: true, transparentRight: false);
                    break;
                case Type.TransparentEdgesRight:
                    GenerateTransparentEdgesSprite(toFill, transparentLeft: false, transparentRight: true);
                    break;
                ...
                case Type.Cropped:
                    ...
                    break;
                case Type.SimpleOutside:
                    GenerateSimpleOutsideSprite(toFill, m_PreserveAspect);
                    break;
            }
        }
