...
#pragma warning restore 649
      ...
      where TView : IElementView 
    {
      ...
      /// </summary>
      public void replaceAllElements<TId>(IList<TData> elements, Func<TData, Option<TId>> getId)
        where TId : IEquatable<TId>
      {
        var elementDatas = new Dictionary<TId, TData>();
        ...
        var newAssignments = new List<(TView view, TData newData)>();
